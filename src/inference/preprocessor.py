...
Mirrors the feature engineering pipeline in schematics_eda.ipynb
(cells 33-35, 105-134) using precomputed JSON lookup tables.
"""
...
class Preprocessor:
    ...
    def _encode_user(self, session: dict[str, Any]) -> dict[str, float]:
        ...
        # imputation with train medians (cell 117)
    ...
    def _encode_offer(
        ...
        # brand lookup (cell 110, brand_lookup.json)
        ...
        # brand × credit_score lookup (cell 111, brand_credit_lookup.json)
